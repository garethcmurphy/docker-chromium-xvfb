...
docker build -f images/js/Dockerfile-12.x -t markadams/chromium-xvfb-js:12 images/js
docker build -f images/js-onbuild/Dockerfile-12.x -t markadams/chromium-xvfb-js:12-onbuild images/js-onbuild
